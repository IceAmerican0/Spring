...
import com.springlec.address.command.Command;
import com.springlec.address.command.ListCommand;
...
//		model.addAttribute("list",dao.listDao());
	...
	public String edit(HttpServletRequest request,Model model) {
		IDao dao=sqlSession.getMapper(IDao.class);
		dao.editDao(request.getParameter("name"),request.getParameter("telno"),request.getParameter("address"),request.getParameter("email"),request.getParameter("relation"),request.getParameter("seqno"));
		return "redirect:list";
	}
