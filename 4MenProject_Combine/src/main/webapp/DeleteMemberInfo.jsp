<%@page import="com.jsplec.Air4men.dto.AdminUserDto"%>
<%@page import="com.jsplec.Air4men.dao.AdminDao"%>
...
<div class="container-fluid">
          <div class="navbar-header">
            <a class="navbar-brand" href="Client_List.do">4menAir</a>
        </div>     
</div>
...
<div class="container">
	...
	<button onclick="location.href='Recovery_Member.do?userId=${MemberInfo.userId }'" class="btn btn-danger">탈퇴철회</button>
	<button onclick="location.href='DeleteClient_List.do'" class="btn btn-warning">목록보기</button>						 
						 </td>	
					</tr>	
