...
<body>
	<div class="container">
		...
		<a href="main_view.do?userId=${param.userId }" style="text-align:right">메인으로</a>
		<a href="userReservationList_view.do?userId=${param.userId }">예약정보</a>
		<a href="userQnaList_view.do?userId=${userId }">Q & A</a>		
