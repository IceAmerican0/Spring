...
if (request.getParameter("userId") == null)
	response.sendRedirect("userLogin_view.do");
else {
%>
</head>
<body>
    <div class="container-login">
        ...
        <div class="container mt-3">
            ...
            <div class="menuButton mt-5">
                <input type="button" value="회원정보" onClick="location.href='user_myPage_view.do?userId=${param.userId }'">
                <input type="button" value="예약정보" onClick="location.href='userReservationList_view.do?userId=${param.userId }'">
                <input type="button" value="Q & A" onClick="location.href='userQnaList_view.do?userId=${param.userId }'">
                <input type="button" value="공지사항" onClick="location.href='Notice_List.do?userId=${param.userId }'">
            </div>
            <form action="flights_List.do?userId=${param.userId}" class="flightFindForm" name="flightFindForm" method="post">
                <div class="mt-5">
