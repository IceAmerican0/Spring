...
<div class="container">
	...
	<button onclick="location.href='Delete_Member.do?userId=${MemberInfo.userId }'" class="btn btn-danger">회원탈퇴</button>
	<button onclick="location.href='Client_List.do'" class="btn btn-warning">목록보기</button>						 
						 </td>	
					</tr>	
				</table>
