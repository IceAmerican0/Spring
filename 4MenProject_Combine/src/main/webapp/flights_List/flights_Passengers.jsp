...
<body>
    ...
    <div class="container mt-3">
        <div class="row btn-group procedure">
            <input type="button" class="btn col-lg-3 button1" value="검색" onclick="location.href='userLogin.do?userId=${param.userId }'">
            <input type="button" class="btn col-lg-3 button2" id="select" value="항공편 검색" onclick="location.href='flights_List.do?userId=${param.userId }&fromDate=${flights_passengers.select_departures_Date }&from=${flights_passengers.select_departures }'">
    ...
    <div class="container margin_auto_1000 ">
        <div class="row">
            ...
            <div id="demo" class="collapse">
                ...
                <form action="userPayment_view.do" method="post">
