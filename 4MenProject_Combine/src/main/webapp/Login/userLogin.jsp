    ...
    <div class="container-login">
        ...
        <div class="container">
            ...
            <form action="userLogin.do" name="loginForm" method="post">
                ...
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="userRegister_view.do">회원가입</a></li>
                    <li class="nav-item"><a class="nav-link" href="userIdfind_view.do">아이디찾기</a></li>
                    <li class="nav-item"><a class="nav-link" href="userPwfind_view.do">비밀번호찾기</a></li>
                    <div>${msg}</div>
                </ul>
            </form>
            <%-- <%
