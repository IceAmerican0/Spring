...
<div class="row">
	...
	<div class="col-md-8">
		<h2 class="text-center">공지 보기</h2><p>&nbsp;</p>
			<form action="Notice_Modify.do?board_num=${param.board_num}" method="post">
		 	...
		 	<tr>
		  	...
		  	<tr>	
		 		<td colspan="4"  class="text-center">
		 			...
		 			<input type="button" class="btn btn-warning" onClick="location.href='Notice_Delete.do?board_num=${param.board_num}'" value="삭제하기" >
		 			<input type="button" class="btn btn-primary" onclick="location.href='AdminNotice_List.do'" value="목록으로">
		 		</td>
		 	</tr>
	 	...
	 	<%-- <form action="Notice_Modify.do?board_num=${param.board_num}" method="post" enctype="multipart/form-data">
